...
WINDOWS = ['flat', 'hanning', 'bartlett', 'blackman']
# if you want to see just two window type, comment previous line and
...
def smooth(x, window_len=11, window='hanning'):
    ...
    window -- type of window: 'flat', 'hanning', 'hanning',
                    'bartlett', 'blackman'
   ...
   # adding reflected windows in front and at the end
    s = numpy.r_[x[windows_len-1:0:-1], x, x[-1:-window_len:-1]]
